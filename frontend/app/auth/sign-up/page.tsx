...
export default function SignUpPage() {
    ...
    return (
        <div className="relative overflow-hidden min-h-screen bg-surface text-slate-900 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="relative z-10 w-full max-w-md space-y-8 rounded-2xl bg-white/80 backdrop-blur-xl p-8 shadow-2xl border border-white/60">
                <div>
                ...
                <div className="text-center text-sm text-slate-600">
                    ...
                    <Link href="/auth/sign-in" className="font-medium text-indigo-600 hover:text-indigo-500 transition-colors">
                        Sign in
                    </Link>
                </div>
            </div>
